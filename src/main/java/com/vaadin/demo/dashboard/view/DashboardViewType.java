...
import com.vaadin.demo.dashboard.view.charts.ChartsView;
import com.vaadin.demo.dashboard.view.dashboard.DashboardView;
import com.vaadin.demo.dashboard.view.form.FormView;
...
public enum DashboardViewType {
    DASHBOARD("dashboard", DashboardView.class, FontAwesome.HOME, true), SALES(
            ...
            "schedule", ScheduleView.class, FontAwesome.CALENDAR_O, false), CHARTSVIEW(
                    "charts", ChartsView.class, FontAwesome.BAR_CHART_O, false), FORM(
                            "form", FormView.class, FontAwesome.CAR, false);
